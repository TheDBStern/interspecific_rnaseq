...
.mRNA transdecoder output file and renames transcripts in the second fasta file to the corresponding ones in the first
...
Note: This assumes cRBH was run on the transdecoder.pep files. The cRBH scripts of Salikos and Rochas 2011 require no special characters in the
 fasta file names (besides "_"). The original file names should be returned before running (i.e. TR28398|c0_g1_i1|m.1829)
'''
